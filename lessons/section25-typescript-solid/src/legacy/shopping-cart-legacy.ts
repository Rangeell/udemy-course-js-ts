/*
Esse diretório foi criada para armazenar a versão original da classe `ShoppingCart`. Isso permite a comparação entre o código antes e depois da aplicação dos princípios.
*/
