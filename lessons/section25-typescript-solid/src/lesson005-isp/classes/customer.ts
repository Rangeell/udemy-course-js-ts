...
import type { IndividualCustomerProtocol, EnterpriseCustomerProtocol } from '../interfaces/customer-protocol.js';

// Classe que representa o cliente (pessoa física)
...
// Classe que representa o cliente (pessoa jurídica)
