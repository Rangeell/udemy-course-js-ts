/*
Como lidar com o this em arrow functions
*/
...
form.addEventListener('submit', (e: Event): void => {
  // this aponta para quem chamou o evento -> window

  e.preventDefault();
  const target = e.target as HTMLFormElement; // Solução
  ...
  return shouldSendForm(target) ? console.log('Formulário enviado com sucesso!') : console.log('Não enviado');
  ;
});
